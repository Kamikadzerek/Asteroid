...
Ship.prototype.draw = function(){
	...
	if(this.points[0].x>VAR.W && this.points[1].x>VAR.W && this.points[2].x>VAR.W){
		this.x-=(Math.max(this.points[0].x, this.points[1].x, this.points[2].x));
	}
	...
	if(this.points[0].y>VAR.H && this.points[1].y>VAR.H && this.points[2].y>VAR.H){
		this.y-=(Math.max(this.points[0].y, this.points[1].y, this.points[2].y));
	}
